...
const EditBookForm = ({ book, onClose, genres }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {book?.image && (
              <div className="mb-2">
                <img 
                  src={book.image.startsWith('http') ? book.image : `http://localhost:8000${book.image}`}
                  alt="Current cover" 
            ...
            />
            {imageFile && (
              <p className="text-sm text-gray-500 mt-1">New image: {imageFile.name}</p>
            )}
          </div>
